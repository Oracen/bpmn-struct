...
type Collaboration struct {
	...
	MessageFlow              []MessageFlow                `xml:"messageFlow" json:"messageFlow"`
	MessageFlowAssociations  []MessageFlowAssociation     `xml:"messageFlowAssociations" json:"messageFlowAssociations"`
